...
UI.Checkbox.prototype.setEnabled = function( enabled ) {
	if(enabled === undefined || enabled == null) {
		enabled = false;
	}
	this.dom.disabled = !enabled;
...
UI.Number.prototype.setEnabled = function( enabled ) {
	if(enabled === undefined || enabled == null) {
		enabled = false;
	}
	this.dom.disabled = !enabled;
...
UI.Number.prototype.getEnabled = function( ) {
	return !this.dom.disabled;
};
...
UI.LoadingScreen.prototype.update = function ( currStep, totalSteps, stepName, size, progress ) {
	...
	this.textProgress.setValue("Progress: " + progress + " of " + size + " loaded");
}
